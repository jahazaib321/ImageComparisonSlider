<?php
namespace Mage4\ImageComparisonSlider\Helper;
...
class Image extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     */
    const DIRECTORY = 'mage4/comparisonslider/image/';
    /**
    ...
    public function resize($image, $width = null, $height = null)
    {
        ...
        $imageResized = $this->_mediaDirectory->getAbsolutePath('mage4/comparisonslider/image/') . $image;
        ...
        return $this->_storeManager->getStore()->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA) . 'mage4/comparisonslider/image/' . $image;
    }
}
